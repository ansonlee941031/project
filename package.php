...
if (isset($_POST['add_package'])) {
    ...
    if (isset($_FILES['fileToUpload']) && $_FILES['fileToUpload']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $message = "warning: 包裹資料已建立，但圖片上傳失敗。";
        }
    }
    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-header bg-primary text-white fw-bold">1. 包裹抵達登記</div>
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="add_package" class="btn btn-primary w-100">新增包裹記錄</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-header bg-success text-white fw-bold">2. 包裹簽收登記</div>
                <div class="card-body">
